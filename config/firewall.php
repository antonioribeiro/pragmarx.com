...
return [
    ...
    'block_response_message' => 'Your access to this page was denied.',

    'block_response_abort' => false, // return abort() instead of Response::make() - disabled by default

    /**
     * Do you wish to redirect non blacklisted  to an error page?
     *
     * You can use a route name (coming.soon) or url (/coming/soon);
     *
     */

    'block_response_page' => '/firewall/forbidden',
    ...
    'redirect_non_whitelisted_to' => '/firewall/forbidden',
